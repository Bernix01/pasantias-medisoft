...
struct ColorSpot: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        path.addCurve(to: CGPoint(x: 0.4375*width,
                                  y: 0.14583*height),
                      control1: CGPoint(x: 0.125*width, y: 0.14583*height),
                      control2: CGPoint(x: 0.1875*width, y: 0.10417*height))
        path.addCurve(to: CGPoint(x: 1*width, y: 0.14583*height),
                      control1: CGPoint(x: 0.625*width, y: 0.16667*height),
                      control2: CGPoint(x: 0.75*width, y: 0.16667*height))
